...
:::warning
**Trata de evitar este método que expone tu fuente de datos.** Antes de hacer esto, revisa las alternativas que tienes en [Conectarse a base de datos fuera de la VPC](https://www.notion.so/Conectarse-a-base-de-datos-fuera-de-la-VPC-1cae5232819f802aaabdd9b9adbbf97b7?pvs=21).
:::
