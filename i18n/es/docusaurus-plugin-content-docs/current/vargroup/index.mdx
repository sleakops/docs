...
If a service is not selected the resulting var group is _global_ and is available for all the [namespace](/environment.mdx#infrastructure-created-with-an-environment).
