...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img src="/img/projects/dockertron_input.png" alt="docketron_input" />
</Zoom>
...
Una vez completada la información, haga clic en el botón **"Save"** para enviar su proyecto a Dockertron.

El sistema recibirá:

- **Repositorio**: su código fuente
- **Contexto del lenguaje**: Lenguaje y versión especificados
- **Contexto de frameworks**: Frameworks, comandos y versiones configurados
</details>
...
Para más información o soporte, contacte al equipo de SleakOps.
