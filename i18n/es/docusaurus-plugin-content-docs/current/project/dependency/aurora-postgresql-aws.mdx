...
| **Versión del Motor de la Base de Datos** | Selecciona la versión específica del motor de la base de datos Aurora PostgreSQL. Elige entre las versiones 15.4, 15.8, 16.1, o 16.4. Cada versión incluye características específicas de PostgreSQL y actualizaciones de seguridad. |
