...
| --- | --- | 
| **Nombre de Dominio** | El identificador único para tu clúster de OpenSearch. |
| **Versión del Motor** | Especifica la versión de OpenSearch que se utilizará. |
| **Nodos por Zona de Disponibilidad** | El número de nodos de datos de OpenSearch que deseas ejecutar en cada zona de disponibilidad. |
| **Tamaño de Almacenamiento EBS por Nodo** | Define el tamaño de almacenamiento en GiB para cada nodo. El mínimo es 10 GiB y el máximo es 2048 GiB. Rango: 10 a 2048 GiB. |
| **Tipo de Instancia** | Selecciona el tipo de instancia para los nodos de datos de OpenSearch. Ejemplo: r6g.large.search |
| **Número de Zonas de Disponibilidad** | El número de nodos de datos de OpenSearch que deseas ejecutar en cada zona de disponibilidad. |
| **Master Dedicado Habilitado** | Habilita nodos maestros dedicados, mejorando la estabilidad del dominio. Se recomienda para entornos de producción. |
