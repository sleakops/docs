...
Un "Web Service" en SleakOps es un servicio en ejecución continua que proporciona interfaces y end points para la interacción con usuarios, otros servicios y aplicaciones. Su función principal es gestionar solicitudes como:

- Servir páginas web
- Procesar llamadas API
- Gestionar la autenticación de usuarios

Los Servicios Web están diseñados para estar siempre activos, asegurando disponibilidad constante y capacidad de respuesta para mantener una experiencia de usuario y funcionalidad del sistema sin interrupciones.
...
En el _Panel izquierdo_, accede a _Ejecutaciones_. Luego selecciona la pestaña _Servicios Web_ y, en la esquina superior derecha, haz clic en el botón _Crear_.
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
<img
    src="/img/executions/webservice/webservice-create-p1.png"
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
<img
    src="/img/executions/webservice/webservice-create-p2.png"
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
<img
    src="/img/executions/webservice/webservice-create-p3.png"
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
<img
    src="/img/executions/webservice/webservice-create-p4.png"
