...
Una vez que las Cuentas están activas, asignamos a cada una lo que llamamos [Módulo de Red](/network), que contiene una variedad de servicios de AWS utilizados para realizar conexiones de red dentro de las cuentas.
