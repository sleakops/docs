...
Para configurar y gestionar volúmenes con EFS dentro de SleakOps, sigue las instrucciones en la [documentación de volúmenes](/project/volumes). Esta guía cubre la creación y gestión de volúmenes para tus Proyectos y la configuración de ajustes de EFS dentro de tu clúster.
</details>
