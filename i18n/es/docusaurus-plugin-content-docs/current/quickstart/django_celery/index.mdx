...
Con estos campos estamos listos para avanzar. Hacemos clic en el botón "Next" en la parte inferior derecha y luego en "Submit", con esto ya hemos creado nuestra base de datos:
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
