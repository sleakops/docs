...
:::warning
**Try to avoid this method as it exposes your data source.** Before proceeding, review the alternatives available in [Connect to database outside VPC](https://www.notion.so/Conectarse-a-base-de-datos-fuera-de-la-VPC-1cae5232819f802aaabdd9b9adbbf97b7?pvs=21).
:::
