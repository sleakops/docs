...
- Usar [**KEDA** (Kubernetes Event-Driven Autoscaling)](/tutorial/install-keda) para escalar Workers basándose en métricas de profundidad de la cola
...
| **Worker + [autoescalado KEDA](/tutorial/install-keda)** | Carga variable; escalar a cero cuando no hay trabajo |
