...
El mismo campo está disponible en el alta. En el paso **Connection Settings** del formulario del Web Service, expandí la sección **Advanced** y completá **Extra Annotations** dentro de **Ingress Annotations**. La anotación se aplica a todos los hosts del Web Service: su URL por defecto y cualquier Domain propio que apunte a él.

{/* TODO: screenshot - paso Connection Settings con la sección Advanced expandida, mostrando Ingress Annotations */}
