...
{/* TODO: screenshot - Consola de AWS mostrando el Account ID en el menú desplegable */}
...
{/* TODO: screenshot - Consola de AWS mostrando la lista de VPCs con las columnas VPC ID e IPv4 CIDR */}
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/atlas-network-access-peering.png"
    alt="Pestaña Peering en Network Access de MongoDB Atlas"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/atlas-peering-form.png"
    alt="Formulario de peering en MongoDB Atlas con los datos de AWS"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/atlas-peering-waiting.png"
    alt="Conexión de peering en MongoDB Atlas esperando aprobación"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/aws-peering-pending-1.png"
    alt="Lista de conexiones de VPC Peering en AWS con solicitud pendiente"
  />
</Zoom>

<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/aws-peering-pending-2.png"
    alt="Detalle de la solicitud de VPC Peering pendiente en AWS"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/aws-peering-accept-1.png"
    alt="Diálogo para aceptar la solicitud de VPC peering en AWS"
  />
</Zoom>

<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/aws-peering-accept-2.png"
    alt="Confirmación de solicitud de VPC peering aceptada en AWS"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/atlas-peering-available-1.png"
    alt="Estado de conexión de peering Available en MongoDB Atlas"
  />
</Zoom>

<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/atlas-peering-available-2.png"
    alt="Confirmación del estado Available de la conexión de peering en MongoDB Atlas"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/aws-route-table.png"
    alt="Lista de Route Tables en AWS"
  />
</Zoom>

<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/aws-route-table-edit.png"
    alt="Route Table de AWS con la ruta de peering de Atlas agregada"
  />
</Zoom>
...
{/* TODO: screenshot - MongoDB Atlas IP Access List con el CIDR de la VPC agregado */}
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/atlas-custom-dns.png"
    alt="Configuración de Project en MongoDB Atlas con Custom DNS para VPC peering habilitado"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/atlas-connection-modal.png"
    alt="Modal de conexión de MongoDB Atlas mostrando la opción Private IP for Peering"
  />
</Zoom>

<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/atlas-private-connection-string.png"
    alt="Connection string privado de peering en MongoDB Atlas"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/pritunl-add-route.png"
    alt="Configuración del servidor Pritunl mostrando la ruta del CIDR de Atlas"
  />
</Zoom>

<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/tutorials/how-to-set-up-vpc-peering-between-aws-and-mongodb-atlas/pritunl-route-saved.png"
    alt="Servidor Pritunl con la ruta del CIDR de Atlas guardada"
  />
</Zoom>
