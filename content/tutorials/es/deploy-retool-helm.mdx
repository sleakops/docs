...
- [EBS CSI Driver](/docs/cluster/addon/ebs-csi-driver) instalado (necesario para el volumen de PostgreSQL)
- [EFS CSI Driver](/docs/cluster/addon/efs-csi-driver) instalado (necesario para el almacenamiento de apps y flujos de Retool)
