...
For detailed options, refer to the [SleakOps PostgreSQL dependency docs](/docs/project/dependency/postgresql-aws#how-do-i-create-a-postgresql-database-dump).
