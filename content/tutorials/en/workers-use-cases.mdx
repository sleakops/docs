...
- Use [**KEDA** (Kubernetes Event-Driven Autoscaling)](/tutorial/install-keda) to scale Workers based on queue depth metrics
...
| **Worker + [KEDA](/tutorial/install-keda) autoscaling** | Variable load; scale to zero when idle |
