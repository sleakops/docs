...
tags:
  ...
  - kubernetes
  - scaling
image: /img/tutorials/django-celery/django-celery.png
---
...
In step 3 we have to edit the path field and put the endpoint of healthcheck
...
In the first form we will have to select our project and define a name for it.
...
This concludes our project deployment process. We leave you an optional step
