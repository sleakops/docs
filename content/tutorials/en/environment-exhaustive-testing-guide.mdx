...
4. **Fail:** Errors appear when a request lands on a different replica than the one that initiated a session (sticky-session issue) — see [Configure Sticky Sessions](/tutorial/sticky-sessions)
