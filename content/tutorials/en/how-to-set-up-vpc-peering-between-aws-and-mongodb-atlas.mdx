...
{/* TODO: screenshot - AWS Console VPC list showing VPC ID and IPv4 CIDR columns */}
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="MongoDB Atlas Network Access Peering tab"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="MongoDB Atlas peering form with AWS account details"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="MongoDB Atlas peering connection waiting for approval"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="AWS VPC Peering connections list with pending request"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="AWS VPC Peering pending request details"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="AWS Accept VPC peering request dialog"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="AWS VPC peering request accepted confirmation"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="MongoDB Atlas peering connection status Available"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="MongoDB Atlas peering connection Available status confirmation"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="AWS Route Table with Atlas peering route added"
  />
</Zoom>
...
{/* TODO: screenshot - MongoDB Atlas IP Access List with VPC CIDR added */}
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="MongoDB Atlas Project Settings with Custom DNS for VPC peering enabled"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="MongoDB Atlas connection modal showing Private IP for Peering option"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="MongoDB Atlas private peering connection string"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="Pritunl server settings showing Atlas CIDR route configuration"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="Pritunl server with Atlas CIDR route saved"
  />
</Zoom>
