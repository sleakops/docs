...
- The **ARN of the role** in the target account (e.g., `arn:aws:iam::123456789012:role/SleakopsEditorRole`) — get this from the **AWS Switch Role** action in SleakOps. See [AWS Console Authentication](/user/aws_console_authentication)
