...
The same field is available at creation time. In the **Connection Settings** step of the Web Service form, expand the **Advanced** section and fill in **Extra Annotations** under **Ingress Annotations**. The annotation applies to every host of the Web Service — its default URL and any custom Domain pointing at it.

{/* TODO: screenshot - Connection Settings step with the Advanced section expanded, showing Ingress Annotations */}
