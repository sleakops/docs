...
With `app_cookie` you also get two: the one your application sets, and `AWSALBAPP-0` generated by the load balancer. Cookies over 4 KB are sharded into further fragments (`AWSALBAPP-1`, and so on).
