...
If the alias is a direct subdomain of a domain already managed by Sleakops as a Provider or Environment (e.g. `api.external-domain.com` under `external-domain.com`):
- ✅ Reuses that domain's certificate automatically — no separate SSL validation needed
...
```mermaid
graph TD
    A[sleakops.com<br/>🔑 Delegated to Sleakops] --> B[prod.sleakops.com<br/>✅ Auto-managed]
    A --> C[qa.sleakops.com<br/>✅ Auto-managed]
    B --> D[api.prod.sleakops.com<br/>✅ Auto-managed]
    B --> E[web.prod.sleakops.com<br/>✅ Auto-managed]
    C --> F[api.qa.sleakops.com<br/>✅ Auto-managed]
...
```mermaid
graph TD
    A[sleakops.com<br/>👤 You Control] -.-> B[prod.sleakops.com<br/>🔑 Delegated to Sleakops]
    A -.-> C[qa.sleakops.com<br/>🔑 Delegated to Sleakops]
    B --> D[api.prod.sleakops.com<br/>✅ Auto-managed]
    B --> E[web.prod.sleakops.com<br/>✅ Auto-managed]
    C --> F[api.qa.sleakops.com<br/>✅ Auto-managed]
...
- ✅ SSL certificates for delegated environments
- ✅ DNS records within delegated zones
...
- ✅ Automatic webservice DNS within each environment
...
```mermaid
graph TD
    A[sleakops.com<br/>👤 You Control] -.-> B[prod.sleakops.com<br/>👤 You Control]
    A -.-> C[qa.sleakops.com<br/>👤 You Control]
    B -.-> D[api.prod.sleakops.com<br/>⚙️ Manual CNAME]
    B -.-> E[web.prod.sleakops.com<br/>⚙️ Manual CNAME]
    C -.-> F[api.qa.sleakops.com<br/>⚙️ Manual CNAME]
...
- 📋 ALB endpoints for traffic routing
...
- 🔐 Keep DNS within existing security boundaries
- 📊 Integration with existing DNS monitoring
...
| Time to Deploy | ⚡ Instant | ⚡⚡ Minutes | ⚡⚡⚡ Manual |
