...
Once the connection is established role is created, SleakOps will automatically start the Organizative Unit creation. If your root account already belongs to an AWS Organization, SleakOps reuses it instead of creating a new one.
