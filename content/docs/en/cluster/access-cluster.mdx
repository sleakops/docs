...
:::tip
Prefer not to install a desktop client? The [Headlamp](/docs/cluster/addons/headlamp) add-on gives you a browser-based Kubernetes UI, with no Kubeconfig or Lens installation required.
:::
