...
To set up and manage volumes using EFS within SleakOps, follow the instructions in the [Volumes documentation](/docs/project/volumes). This guide covers creating and managing volumes for your Projects and configuring EFS settings within your cluster.
</details>
