...
All OpenTelemetry data is accesible through Grafana. Check [our Grafana documentation](/cluster/addons/grafana) to learn more about our implementation.
...
Telemetry data consist of three main components: traces, metrics and logs. For logs Sleakops offers [Loki](/cluster/addons/loki). Traces are the path of a request through the system, while metrics are the values of the system at a given time. 
