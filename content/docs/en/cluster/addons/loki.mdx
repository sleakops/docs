...
:::warning Deprecated
The Loki add-on is **deprecated**. SleakOps offers a newer LokiV2 add-on (currently in Beta) with the same log-aggregation capabilities — ask your SleakOps contact if you'd like to move to it.
:::
