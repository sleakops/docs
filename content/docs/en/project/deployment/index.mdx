...
- [Releases](/docs/project/deployment/release.mdx): These are versioned combinations of your [Workloads](/docs/project/workload) including WebServices, Workers, CronJobs, and Hooks.
- Build Image: Represented by a [Build](/docs/project/build).
- Configuration Values: These comprise resources like [Volumes](/docs/project/volumes.mdx) and [VariableGroups](/docs/project/vargroup).
...
Various methods exist to generate a Deployment. These are outlined below. Note that we force certain Deployments. For details, refer to [More on Deployment](/docs/project/deployment/more_on_deployment.mdx#forced-deployments).

- [Workloads](/docs/project/workload/index.mdx): Provides a switcher allowing you to decide whether to run a new Deployment.
...
- [Dependency](/docs/project/dependency): Triggers a Deployment automatically. Delve deeper into this at [More on Deployment](/docs/project/deployment/more_on_deployment.mdx).
