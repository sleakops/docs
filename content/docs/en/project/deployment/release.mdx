...
In Sleakops, a release represents a deployable state of all the Workloads (web services, workers, cron jobs, hooks) of a [project](/project) in an [environment](/environment).
