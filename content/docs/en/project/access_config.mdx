...
:::info
Applying changes requires the project to be in **Created** or **Error** state. While the change is applied, the project shows **Updating**.
:::
...
The Extra Policies section allows you to attach additional IAM policies to your project, providing enhanced permissions beyond the default project access. You can attach up to **10 extra policies** per project.
