...
In SleakOps, a Workload is simply a user-defined workload that runs within the cluster. Depending on how and when you need your workload to run, you can choose from five different types:
...
- If you set **Memory Request** to `512Mi` without specifying a limit, SleakOps will automatically set **Memory Limit** to `666Mi` (approximately 130%)
