...
When creating or updating a Web Service, you can set the terminationGracePeriod in **Step 3: Service Settings**. This field allows you to specify the number of seconds Kubernetes should wait before forcefully stopping your service.
