...
### 3. Specify your worker settings
Configure how the worker behaves and click _Next_.
...
| **Replicas** | The number of replicas to run when auto-scaling is disabled. Default: `1`.  |
...
| **Replicas Min** | The minimum number of replicas to maintain when auto-scaling is active. |
