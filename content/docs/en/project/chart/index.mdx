...
Saving changes redeploys the Project immediately by default. Turn off the **Deploy?** toggle before saving to hold the change instead of deploying it right away.
...
<details>
  ...
  No, modifying SleakOps' built-in templates isn't supported. Use [**Extra
  Templates**](/docs/project/chart/extra_templates) to add resources alongside them instead.
</details>
