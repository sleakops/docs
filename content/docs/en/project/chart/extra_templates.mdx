...
:::info Namespace Requirement
Every template must explicitly set `metadata.namespace` to your Project's namespace, as in the example below. A missing or different namespace gets the template rejected, the same as a cluster-scoped resource.
:::
