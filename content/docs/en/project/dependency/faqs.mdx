...
### **Can I copy a dependency to another Project or Account?**

</summary>
Yes, use **Clone** from the dependency's actions menu. It pre-fills a new dependency with the same configuration and lets you pick the destination Project-Environment, including one in a different Account.
