...
| **Enable KMS Encryption** | Encrypt objects server-side with a KMS key, automatically created for you. |
...
| **AWS DataSync** | Transfers data using AWS DataSync, better suited for large datasets. Requires a dedicated IAM role, which SleakOps also provisions for you via a CloudFormation quick-create link. |
