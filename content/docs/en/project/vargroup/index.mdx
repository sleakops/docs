...
Any authenticated user with access to the account can reveal Vargroup values, including Viewers. Creating, editing, and deleting Vargroups is restricted to Admins and Editors.
</details>
...
Select **FILE** to mount variables as files inside your workload containers. When using this type, you must also provide a **Mount Path** — the directory where the files will be mounted (an absolute path, unique across the project's Vargroups).
