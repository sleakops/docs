...
We have repeteadly talked about Build in both [Project documentation ](/docs/project/index.mdx) and [Initial Build documentation](/docs/project/index.mdx). A build is basically a template of an OS, libraries and other dependencies of the project you deploy.
