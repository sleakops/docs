...
- Sleakops account
- A Cluster in this account. If you don't have one, [here's the documentation on how to do it](/docs/cluster).
- A configured Environment. If you don't have one, [here's the documentation on how to do it](/docs/environment)
...
For more information, you can see our [project documentation](/docs/project)
...
For more information, you can see our [workloads documentation](/docs/project/workload)
...
Sleakops leverages AWS services to offer you alternatives. You can see more information in [dependencies documentation](/docs/project/dependency)
...
- **Read replicas**: Use read replicas for reporting and analytics queries. (You can do this from Sleakops from the [Postgres](/docs/project/dependency/postgresql-aws) configuration)
- **Indexing**: Optimize database indexes for workflow execution queries
- **Backup strategies**: Implement automated backups with point-in-time recovery. (You can do this from Sleakops from the [Postgres](/docs/project/dependency/postgresql-aws) configuration)
