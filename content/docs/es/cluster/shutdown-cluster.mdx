...
Cuando tu cluster se vuelve a encender, SleakOps restaura exactamente los mismos Node Pools que tenía antes de apagarse.
...
:::info
El encendido/apagado manual solo está disponible una vez que el Apagado Programado fue configurado para el cluster. Si no lo configuraste, SleakOps te va a pedir que definas un horario antes de poder apagarlo.
:::
