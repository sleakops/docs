...
:::tip
¿Preferís no instalar un cliente de escritorio? El add-on [Headlamp](/docs/cluster/addons/headlamp) te da una interfaz de Kubernetes desde el navegador, sin necesidad de instalar Kubeconfig ni Lens.
:::
