...
:::warning Deprecado
El Add-on de Loki está **deprecado**. SleakOps ofrece un nuevo Add-on LokiV2 (actualmente en Beta) con las mismas capacidades de agregación de logs — consultá con tu contacto de SleakOps si querés migrar a él.
:::
