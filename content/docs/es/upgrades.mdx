...
| **Actions** | Ver detalle, Ejecutar y (cuando aplica) Revisar instrucciones. Las filas de EKS Cluster Upgrade reemplazan Ejecutar por **Review upgrade plan**, que abre la pestaña Upgrade del drawer. |
...
1. **Desde la lista** — clic en el ícono verde de play en la columna Actions. Las filas de EKS Cluster Upgrade no tienen este atajo — hacé clic en **Review upgrade plan** para abrir la pestaña Upgrade del drawer y ejecutar desde ahí.
...
Hacé clic en cualquier fila para abrir el drawer. Tiene hasta tres pestañas, según el tipo de upgrade:
