...
Una vez que las Cuentas están activas, asignamos a cada una lo que llamamos [Módulo de Red](/docs/network), que contiene una variedad de servicios de AWS utilizados para realizar conexiones de red dentro de las cuentas.
...
La Cuenta de Seguridad centraliza la administración de usuarios de IAM y sus permisos de acceso al sistema. No aparece en tu listado de cuentas — accedes a las demás cuentas desde ella cambiando de rol. Aprende cómo cambiar entre cuentas en [Autenticación de Consola de AWS](../user/aws_console_authentication).
...
![account-switcher](/img/imagentestaccount.png "Account Switcher")
    ...
    <p>Los Editores y Viewers solo ven las cuentas a las que se les otorgó acceso.</p>
  </div>
</div>
