...
Si el alias es un subdominio directo de un dominio ya gestionado por Sleakops como Proveedor o Entorno (ej. `api.dominio-externo.com` bajo `dominio-externo.com`):
- ✅ Reutiliza el certificado de ese dominio automáticamente — no necesita validación SSL propia
