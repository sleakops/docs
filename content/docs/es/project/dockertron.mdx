...
Para iniciar el proceso de dockerización, elija el repositorio privado y la rama a analizar, y luego responda un breve cuestionario sobre su proyecto para que la IA tenga suficiente contexto. Solo están disponibles los repositorios privados de su integración Git conectada.
