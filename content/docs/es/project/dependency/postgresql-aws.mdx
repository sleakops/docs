...
| **Restore From Point In Time** | Crea la base de datos restaurada a un momento específico (o al punto restaurable más reciente) de una base de datos origen, en vez de arrancar vacía. Mutuamente excluyente con restaurar desde un snapshot. |
