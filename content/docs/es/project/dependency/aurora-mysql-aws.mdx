...
| **Réplicas de Lectura** | Configuración para réplicas de lectura de la base de datos. Cada réplica requiere un nombre y configuración de acceso público; también se pueden agregar, editar o quitar más adelante desde el formulario de edición. |
