...
| **Habilitar Cifrado KMS** | Cifra los objetos del lado del servidor con una clave KMS, creada automáticamente por vos. |
...
| **AWS DataSync** | Transfiere datos usando AWS DataSync, más adecuado para volúmenes grandes de datos. Requiere un rol IAM dedicado, que SleakOps también provisiona mediante un link de CloudFormation quick-create. |
