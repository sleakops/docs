...
En el _Panel izquierdo_, accede a _Workloads_. Luego selecciona la pestaña _Worker_ y, en la esquina superior derecha, haz clic en el botón _Crear_.
...
| **Comando** | El comando que ejecuta el worker. |
...
### 3. Especifica los ajustes de tu Worker
Configura el comportamiento del worker y haz clic en _Siguiente_.
...
| **Replicas** | El número de réplicas a ejecutar cuando el auto-escalado está desactivado. Predeterminado: `1`. |
...
| **Replicas Min** | El número mínimo de réplicas que deben mantenerse cuando el auto-escalado está activo. |
...
Envía para crear y desplegar tu worker.