...
Al crear o actualizar un Web Service, puedes configurar el **terminationGracePeriod** en el **Paso 3: Service Settings**. Este campo te permite especificar el número de segundos que Kubernetes debe esperar antes de detener forzosamente tu servicio.
