...
- **Memory Request** = `512Mi` → **Memory Limit** se convierte automáticamente en `665Mi`
...
SleakOps soporta sitios estáticos de forma nativa: creá un Project con el build method **Static site** y la plataforma compila tu frontend y lo sirve desde S3 a través de CloudFront en tu propio dominio — ver [Sitio Estático](/docs/project/workload/static). Requiere la feature `static` en tu suscripción.
