...
En SleakOps, un Workload es simplemente un trabajo definido por el usuario que se ejecuta dentro del clúster. Dependiendo de cómo y cuándo necesites ejecutar tu carga de trabajo, puedes elegir entre cinco tipos diferentes:
...
- Si estableces **Memory Request** en `512Mi` sin especificar un límite, SleakOps establecerá automáticamente **Memory Limit** en `666Mi` (aproximadamente 130%)
