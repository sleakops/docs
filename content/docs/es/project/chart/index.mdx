...
Guardar cambios redespliega el Proyecto de inmediato por defecto. Desactivá el interruptor **Deploy?** antes de guardar para retener el cambio en vez de desplegarlo enseguida.
...
<details>
  ...
  No, modificar las plantillas integradas de SleakOps no está soportado. Usá
  [**Extra Templates**](/docs/project/chart/extra_templates) para agregar recursos junto a ellas.
</details>
