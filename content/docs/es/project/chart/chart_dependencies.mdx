...
Agregar, editar o eliminar una dependencia dispara una validación en segundo plano del chart de tu proyecto. Si falla, tu proyecto pasa a estado Error y recibís una notificación con el error específico — abrí **Chart Configuration** desde la notificación para corregir la versión o los values de la dependencia, o eliminarla. El proyecto se recupera automáticamente en cuanto el chart valida correctamente.

## Editar y Eliminar una Dependencia

Usá la acción **Edit** de una dependencia para actualizar su versión o sus values (el nombre del chart y el repositorio no se pueden cambiar después de crearla). **Delete** la elimina y dispara un nuevo deploy para sacarla del clúster.
