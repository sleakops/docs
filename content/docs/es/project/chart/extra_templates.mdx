...
:::warning Deprecado en favor de Manifests
Extender templates y values está deprecado. Para agregar o editar recursos personalizados, usa la sección **Manifests** del Project — cada recurso se vuelve su propio manifiesto, con validación, preview y scoping por Workload. Ver la [documentación de Manifests](/docs/project/workload/manifests). Los Extra Templates existentes se siguen desplegando como siempre hasta que los migres.
:::
