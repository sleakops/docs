...
The initially created infrastructure architecture by **SleakOps** when the deployment is made follows the next reference diagram:

<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.1)">
  <img
...
<Zoom overlayBgColorEnd="rgba(5, 5, 5, 0.1)">
