...
sidebar_position: 6
pagination_next: dependency/index
---
...
:::warning
You must have your Git Repository connected. See [Connect your Git Account](/project/connect_to_git)
:::
...
| **Nodepool** | Is the resource in charge of provision the server where your services will run. More info [here](/cluster/nodepools/index). |
