...
| **Database Engine Version** | Select the specific version of the MariaDB database engine. Choose from versions 11.4, 10.6, or 10.11. Each version includes specific MariaDB features, performance improvements, and security updates. |
