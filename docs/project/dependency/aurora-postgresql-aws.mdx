...
| **Database Engine Version** | Select the specific version of the Aurora PostgreSQL database engine. Choose from versions 15.4, 15.8, 16.1, or 16.4. Each version includes specific PostgreSQL features and security updates. |
