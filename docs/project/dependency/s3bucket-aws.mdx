...
To create a backup of your S3 bucket data, follow these steps:
  ...
  aws sts assume-role --role-arn arn:aws:iam::ACCOUNT_ID:role/SleakopsAdminRole --output json
  export AWS_ACCESS_KEY_ID="..."
  export AWS_SECRET_ACCESS_KEY="..."
  export AWS_SESSION_TOKEN="..."

  aws s3 sync s3://BUCKET_NAME /path/to/local/directory --delete --exclude "*.tmp"```
