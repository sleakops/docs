...
Yes, Amazon MSK supports Kafka version upgrades. You can upgrade between the supported versions: 2.8.1, 3.2.0, 3.3.2, 3.4.0, and 3.5.1. However, the upgrade process requires careful planning and may involve downtime. It's recommended to test the upgrade process in a non-production environment first.
</details>
