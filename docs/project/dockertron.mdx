...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img src="/img/projects/dockertron_location.png" alt="docketron_location" />
</Zoom>
...
Once the information is complete, click the **"Save"** button to submit your project to Dockertron.


The system will receive:

- **Repository**: your source code
- **Language context**: Specified language and version
- **Framework context**: Configured frameworks, commands, and versions
</details>
...
For more information or support, contact the SleakOps team.
