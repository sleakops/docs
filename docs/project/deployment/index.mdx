...
- [Releases](/project/deployment/release.mdx): These are versioned combinations of your [Services](/project/service) including WebServices, Workers, CronJobs, and Hooks.
...
- [Service](/project/service/index.mdx): Provides a switcher allowing you to decide whether to run a new Deployment.
