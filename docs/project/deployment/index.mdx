...
- [Releases](/project/deployment/release.mdx): These are versioned combinations of your [Services](/project/workload) including WebServices, Workers, CronJobs, and Hooks.
...
- [Service](/project/workload/index.mdx): Provides a switcher allowing you to decide whether to run a new Deployment.
- [VariableGroup](/project/vargroup): Operates similarly to Services but doesn't create a new Release. Instead, it only updates the [values](https://helm.sh/docs/chart_best_practices/values/) of the Deployment.
