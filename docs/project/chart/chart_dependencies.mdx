...
persistence:
  ...
  size: 5Gi
```
3. In case you need another storageClass, you can define it as an [extra template](/project/chart/extra_templates) and use it. Remember to set the provisiner to `ebs.csi.aws.com`.
...
persistence:
  ...
  size: 5Gi
```
3. In case you need another storageClass, you can define it as an [extra template](/project/chart/extra_templates) and use it. Remember to set the provisiner to `efs.csi.aws.com`.
