...
| **Account to be used** | Use all accounts as described [here](/docs/provider/accounts)  | Only the *Production* account |
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="Sleakops MultiSchema Example"
    style={{ width: '1000px' }}
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    ...
    alt="Sleakops SingleSchema Example"
    style={{ width: '600px' }}
  />
</Zoom>