...
The Security Account serves as a centralized hub for managing IAM users and their access to the system. Learn how to switch between accounts in [AWS Console Autentication](https://docs.sleakops.com/user/aws_console_authentication).
