...
Account Security:
In this account, we will keep all the users who have access to this provider.

Account Management:
This account is designed to maintain internal services that are used for the maintenance of the application, whether shared across accounts or not. Example: Sentry.

Account Development:
This account is for maintaining the different stages of your application before it goes into production.
