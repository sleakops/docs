...
# AWS Provider: Architecture Overview
...
Every account has a VPN instance that is generated from the creation of the first cluster.

### Segurity account

- Handler user to administrate user access.
...
- Route53 serves as a DNS and performs health checks for the application.
