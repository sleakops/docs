...
The initial and main thing SleakOps uses to organize everything is the [Reference Architecture](provider/awsprovider/aws) so you will need to understand this structure, most of this stuff is created on the [Provider](/provider/index.mdx) step of the Onboarding.
