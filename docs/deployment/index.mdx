...
A Deployment in Sleakops signifies the introduction of a new version of your application. This involves three primary components, collectively representing a Helm Release:
...
There are multiple ways to generate a Deployment, these are shown [below ](#running-a-deploy)
