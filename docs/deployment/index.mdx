...
When you creates a Sleakops deployment a Helm release will be installed in your [cluster](/docs/cluster) using a Helm chart built when a [release](/docs/deployment/release.mdx) is created
