...
To create a release you must have one or more services with unreleased changes ('draft' state), a [environment](../environment) and a version number to set to the release
after that you are ready to [deploy](../deployment) this realease on selected [cluster](../cluster).
