...
A node pool is essentially a collection of nodes within a Kubernetes cluster that have similar configurations, such as the same machine t
...
| **Instance Type** | Select between Spot and On Demand based on your needs. See [**What are the different kind of node pools?**](https://www.notion.so/What-are-the-different-kind-of-node-pools-2e67cad90e9f4ed29f615b51d43bde6b?pvs=21)  |
