...
For detailed guidance on choosing the right instance types and evaluating application compatibility, see [Instance Types and Node Management](/docs/cluster/nodepools/instance-types).
</details>
...
Follow [Creating a Node Pool](/docs/cluster/nodepools/creating-nodepool) 
</details>
...
Follow [Managing a Node Pool](/docs/cluster/nodepools/managing-nodepool) 
</details>