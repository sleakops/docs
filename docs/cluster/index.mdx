...
On the left pane, you will see a selector with the account names, select the one you’ll use based on how you  decide to manage your clusters and [environments](/environment). 
