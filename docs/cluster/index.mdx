...
To define how to create your infra, you can see: [Designing your Infra: Single Schema Vs. Multi Schema ](/provider/schemas)
</details>
...
SleakOps creates a group of Node Pools that will allow you to run your applications using Kubernetes orchestration based on your needs. See [Node Pools](/cluster/nodepools).
</details>
...
For more information regarding accounts, see [Accounts](/provider/accounts).
...
This process will create a Cluster with five node pools by default. See [Node Pools](/cluster/nodepools).