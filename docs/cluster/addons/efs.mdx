...
You should use EFS when need a volume that will be mounted to more than one pod, for example an aplication running in the Cluster with two replicas or more
</details>
