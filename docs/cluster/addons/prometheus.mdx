...
---
sidebar_label: Prometheus: Monitoring System 
...
Prometheus works as an intermediary Addon as it's components are widely used by other Addons like, for example: Grafana, Kubecost, OpenTelemetry, etc.
...
- It depends on the [EBS CSI Driver <FiExternalLink/>](/cluster/addons/ebs.mdx) Addon for short-term storage.
