...
- A Environment configured. If you don't have it, [here is the documentation on how to do it](/environmentZ)
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/quickstart/django_celery/click-create-collecstatic-hook.png"
    alt="click-create-collecstatic-hook-reference"
  />
</Zoom>
...
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
    src="/img/quickstart/django_celery/create-collecstatic-hook.png"
    alt="create-collecstatic-hook-reference"
  />
</Zoom>
...
With these fields we are ready to move forward. We click on the “Next” button at the bottom right and then on “Submit”, with this we have already created our database:
<Zoom overlayBgColorEnd="rgba(255, 255, 255, 0.8)">
  <img
...
- RABBITMQ_BROKER_USERNAME

With this data we have to build a url as follows:
```bash
