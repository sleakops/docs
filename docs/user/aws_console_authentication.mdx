...
:::tip[VIDEO] How to enter to any of your Accounts.
...
As described in the [Architecture Overview](/provider/awsprovider/aws). You'll have to enter the 'security' account, then, assume the role on the account you want. The easiest way to do this is by using the [Sleakops Dashboard](https://console.sleakops.com/):
