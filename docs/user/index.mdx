...
When you create a [Provider ](/provider/index.mdx) you get a Pritunl VPN where you need a profile so we also create a profile on the VPN. To manipulate the AWS resources through the console or, for example, through Lens, you must be connected to it. To do that you have to download Pritunl and import your profile on the client, find the steps on the [VPN documentation](/vpn.mdx).
