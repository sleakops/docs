...
sidebar_position: 7
pagination_next: service/service/webservice/index
---
...
[S3 Bucket](/dependency/s3bucket-aws).
[MySQL](/dependency/mysql-aws).
[PostgreSQL](/dependency/postgresql-aws).
[Redis](/dependency/redis-aws).
[Memcached](/dependency/memcached-aws).
[OpenSearch](/dependency/opensearch-aws).
[SQS](/dependency/sqs-aws).
