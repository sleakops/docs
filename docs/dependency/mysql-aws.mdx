...
For database solutions, Sleakops supports as a [dependency](./index.md) AWS-managed MySQL RDS, with the benefits of cloud-managed relational database service like scalability, backups, software patchings.
