...
A hosted zone is a container for records, and records contain information about how you want to route traffic for a specific domain, such as [example.com](http://example.com/), and its subdomains ([acme.example.com](http://acme.example.com/), [zenith.example.com](http://zenith.example.com/)). 
